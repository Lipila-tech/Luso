    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_currency', models.CharField(blank=True, max_length=50, null=True)),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='bank', to='accounts.creatorprofile')),
            ],
        ),
    ]
