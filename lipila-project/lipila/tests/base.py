...
class FunctionalTest(StaticLiveServerTestCase):
    ...
    BROWSER_TYPE = webdriver.Firefox
    # BROWSER_TYPE = webdriver.Chrome
    # Change this, to your driver file of your chosen browser
    # BROWSER_DRIVER_PATH: Path = Path(settings.BASE_DIR, '/usr/lib/chromium-browser/chromedriver')
    BROWSER_DRIVER_PATH: Path = Path(settings.BASE_DIR, '/usr/local/bin/geckodriver')
    ...
    def get_browser(cls):
        if cls.BROWSER_TYPE is webdriver.Firefox:
            ...
            service  = Service(executable_path=cls.BROWSER_DRIVER_PATH)
