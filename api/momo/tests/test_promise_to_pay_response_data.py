...
class TestPromiseToPayResponseData(unittest.TestCase):
    """PromiseToPayResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PromiseToPayResponseData:
        """Test PromiseToPayResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PromiseToPayResponseData`
        """
        model = PromiseToPayResponseData()
        if include_optional:
            return PromiseToPayResponseData(
                promise_details = [
    ...
    def testPromiseToPayResponseData(self):
        """Test PromiseToPayResponseData"""
