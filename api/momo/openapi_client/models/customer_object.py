...
class CustomerObject(BaseModel):
    ...
    CustomerObject
    """ # noqa: E501
    firstname: Optional[StrictStr] = Field(default=None, description="Customer First Name.")
    surname: Optional[StrictStr] = Field(default=None, description="Customer surname.")
    email: Optional[StrictStr] = Field(default=None, description="Customer email.")
    msisdn: Optional[StrictStr] = Field(default=None, description="Customer Mobile number.")
    __properties: ClassVar[List[str]] = ["firstname", "surname", "email", "msisdn"]
