...
class PaymentResponseLinks(BaseModel):
    ...
    """ # noqa: E501
    var_self: Optional[PaymentResponseLinksSelf] = Field(default=None, alias="self")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "self": PaymentResponseLinksSelf.from_dict(obj["self"]) if obj.get("self") is not None else None
        })
        return _obj
