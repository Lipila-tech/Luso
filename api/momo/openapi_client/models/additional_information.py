...
class AdditionalInformation(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="Name of additional information item.")
    description: StrictStr = Field(description="Description of additional information item.")
