...
class Bucket(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier of the bucket.")
    name: Optional[StrictStr] = Field(default=None, description="Entity name.")
    description: Optional[StrictStr] = Field(default=None, description="Description of the associated bucket.")
