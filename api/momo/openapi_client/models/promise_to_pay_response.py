...
class PromiseToPayResponse(BaseModel):
    ...
    data: Optional[PromiseToPayResponseData] = None
    links: Optional[ResponseLinks] = Field(default=None, alias="_links")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": PromiseToPayResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "_links": ResponseLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
