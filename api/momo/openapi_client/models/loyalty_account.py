...
class LoyaltyAccount(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier of the loyalty account.")
    name: Optional[StrictStr] = Field(default=None, description="Entity name.")
    description: Optional[StrictStr] = Field(default=None, description="Description of the associated loyalty account.")
