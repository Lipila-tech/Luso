...
class PromiseToPayEligibilityResponse(BaseModel):
    ...
    data: Optional[PromiseToPayEligibilityResponseData] = None
    __properties: ClassVar[List[str]] = ["statusCode", "statusMessage", "transactionId", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": PromiseToPayEligibilityResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
