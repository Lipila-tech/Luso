...
class PaymentItem(BaseModel):
    ...
    PaymentItem
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier of the payment Item")
    item: Optional[PaymentItemItem] = None
    __properties: ClassVar[List[str]] = ["id", "item"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "item": PaymentItemItem.from_dict(obj["item"]) if obj.get("item") is not None else None
        })
        return _obj
