...
class FeeRequestNotFound(BaseModel):
    """
    FeeRequestNotFound
    """ # noqa: E501
    timestamp: Optional[datetime] = Field(default=None, description="Timestamp that the error occurred")
    status: Optional[StrictStr] = Field(default=None, description="Http status")
    ...
    __properties: ClassVar[List[str]] = ["timestamp", "status", "error", "message", "sequenceNo", "path"]
