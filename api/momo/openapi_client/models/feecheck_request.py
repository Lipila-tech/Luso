...
class FeecheckRequest(BaseModel):
    ...
    calling_system: Optional[StrictStr] = Field(default=None, description="calling system.", alias="callingSystem")
    transaction_type: StrictStr = Field(description="calling systemn.", alias="transactionType")
    target_system: Optional[StrictStr] = Field(default=None, description="calling systemn.", alias="targetSystem")
    ...
    amount: Optional[FeeMoneyType] = None
    tax_amount: Optional[FeeMoneyType] = Field(default=None, alias="taxAmount")
    total_amount: FeeMoneyType = Field(alias="totalAmount")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "amount": FeeMoneyType.from_dict(obj["amount"]) if obj.get("amount") is not None else None,
            "taxAmount": FeeMoneyType.from_dict(obj["taxAmount"]) if obj.get("taxAmount") is not None else None,
            "totalAmount": FeeMoneyType.from_dict(obj["totalAmount"]) if obj.get("totalAmount") is not None else None,
