...
class PaymentHistoryResponse(BaseModel):
    ...
    customer_id: Optional[StrictStr] = Field(default=None, description="Customer Id of the customer whose history is being retrieved", alias="customerId")
    sequence_no: Optional[StrictStr] = Field(default=None, description="A unique id for tracing all requests", alias="sequenceNo")
    data: Optional[PaymentHistoryResponseData] = None
    __properties: ClassVar[List[str]] = ["statusCode", "statusMessage", "transactionId", "customerId", "sequenceNo", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": PaymentHistoryResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
