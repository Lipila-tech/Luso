...
class Money(BaseModel):
    ...
    """ # noqa: E501
    unit: Optional[StrictStr] = Field(default=None, description="Currency (ISO4217 norm uses 3 letters to define the currency)")
    value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="A positive floating point number")
