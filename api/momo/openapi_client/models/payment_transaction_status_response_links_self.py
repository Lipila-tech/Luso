...
class PaymentTransactionStatusResponseLinksSelf(BaseModel):
    """
    PaymentTransactionStatusResponseLinksSelf
    """ # noqa: E501
    href: Optional[StrictStr] = Field(default=None, description="Hyperlink to access the financial payment transaction status.")
