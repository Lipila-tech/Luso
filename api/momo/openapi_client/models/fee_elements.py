...
class FeeElements(BaseModel):
    """
    FeeElements
    """ # noqa: E501
    quote_id: StrictStr = Field(description="427842", alias="quoteId")
    fees: FeeElementsFees
    fee_fri: StrictStr = Field(alias="feeFri")
    __properties: ClassVar[List[str]] = ["quoteId", "fees", "feeFri"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fees": FeeElementsFees.from_dict(obj["fees"]) if obj.get("fees") is not None else None,
            "feeFri": obj.get("feeFri")
        })
        return _obj
