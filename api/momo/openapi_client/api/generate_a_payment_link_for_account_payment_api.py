...
class GenerateAPaymentLinkForAccountPaymentApi:
    ...
    def generate_payment_link(
        self,
        order_request: Annotated[OrderRequest, Field(description="Order details for the payment link that is to be created.")],
        ...
        :param order_request: Order details for the payment link that is to be created. (required)
        ...
        _param = self._generate_payment_link_serialize(
    ...
    @validate_call
    def generate_payment_link_with_http_info(
        self,
        order_request: Annotated[OrderRequest, Field(description="Order details for the payment link that is to be created.")],
        transaction_id: Annotated[Optional[StrictStr], Field(description="Client generated Id to include for tracing requests.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def generate_payment_link_without_preload_content(
        self,
        order_request: Annotated[OrderRequest, Field(description="Order details for the payment link that is to be created.")],
        transaction_id: Annotated[Optional[StrictStr], Field(description="Client generated Id to include for tracing requests.")] = None,
        _request_timeout: Union[
    ...
    def _generate_payment_link_serialize(
        self,
        order_request,
        transaction_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/payments/payment-link',
