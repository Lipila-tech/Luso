...
class P2pTransferFeeCheckApi:
    ...
    def inbound(
        self,
        body: Annotated[FeecheckRequest, Field(description="request body")],
        ...
        _param = self._inbound_serialize(
            body=body,
    ...
    @validate_call
    def inbound_without_preload_content(
        self,
        body: Annotated[FeecheckRequest, Field(description="request body")],
        _request_timeout: Union[
            None,
