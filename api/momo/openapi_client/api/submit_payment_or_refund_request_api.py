...
class SubmitPaymentOrRefundRequestApi:
    ...
    def create_payment(
        self,
        payment_request: Annotated[PaymentRequest, Field(description="Payment that is created.")],
        ...
        :param payment_request: Payment that is created. (required)
