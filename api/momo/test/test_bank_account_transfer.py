...
class TestBankAccountTransfer(unittest.TestCase):
    """BankAccountTransfer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BankAccountTransfer:
        """Test BankAccountTransfer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BankAccountTransfer`
        """
    ...
    def testBankAccountTransfer(self):
        """Test BankAccountTransfer"""
