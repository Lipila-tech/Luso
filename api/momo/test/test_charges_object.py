...
class TestChargesObject(unittest.TestCase):
    """ChargesObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChargesObject:
        """Test ChargesObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChargesObject`
        """
        model = ChargesObject()
        if include_optional:
